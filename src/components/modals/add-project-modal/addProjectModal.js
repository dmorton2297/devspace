...
const AddProjectModal = ({ classes, open, onClose, ariaLabelledBy, ariaDescribedby }) => {
    ...
    const validate = () => {
        ...
        if (state.title === '') validation.title = false;
    ...
    return (
        <BaseModal
            ...
            <div className={classes.section}>
                ...
                <TextField error={isInvalid('title')} variant="outlined" label="Title" defaultValue='' placeholder="Title"
                    helperText={isInvalid('title') ? 'Required' : ''} onChange={(event) => {
